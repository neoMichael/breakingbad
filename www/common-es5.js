...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServicesFavoriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var STORAGE_CHARACTER_KEY = 'favouriteCharacters';
    var STORAGE_EPISODE_KEY = 'favouriteEpisodes';
    ...
    var FavoriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavoriteService, [{
        ...
        value: function isFavouriteCharacter(char_id) {
        ...
        value: function favouriteCharacter(char_id) {
          var _this = this;

          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              result.push(char_id);
              return _this.storage.set(STORAGE_CHARACTER_KEY, result);
            } else {
              return _this.storage.set(STORAGE_CHARACTER_KEY, [char_id]);
            }
          });
        }
      }, {
        key: "unfavouriteCharacter",
        value: function unfavouriteCharacter(char_id) {
          var _this2 = this;
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              return _this2.storage.set(STORAGE_CHARACTER_KEY, result);
            }
          });
        }
      }, {
        ...
        value: function isFavouriteEpisode(episode_id) {
        ...
        value: function favouriteEpisode(episode_id) {
          var _this3 = this;

          return this.getAllFavouriteEpisodes().then(function (result) {
            if (result) {
              result.push(episode_id);
              return _this3.storage.set(STORAGE_CHARACTER_KEY, result);
            } else {
              return _this3.storage.set(STORAGE_CHARACTER_KEY, [episode_id]);
            }
          });
        }
      }, {
        key: "unfavouriteEpisode",
        value: function unfavouriteEpisode(episode_id) {
          var _this4 = this;
          ...
          return this.getAllFavouriteEpisodes().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storage.set(STORAGE_CHARACTER_KEY, result);
            }
          });
        }
      }]);
    ...
    FavoriteService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])], FavoriteService);
    /***/
  }
}]);
